...
WSGI_APPLICATION = "aflms.wsgi.application"
ASGI_APPLICATION = "aflms.asgi.application"
...
DEFAULT_FROM_EMAIL = config("DEFAULT_FROM_EMAIL", default="no-reply@aflms.local")
