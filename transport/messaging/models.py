...
# ---------------------------------------------------------------------------
# WhatsAppMessage – every inbound / outbound message logged
# ---------------------------------------------------------------------------
...
class WhatsAppMessage(TimeStampedModel):
    ...
    direction = models.CharField(
        max_length=10, choices=Direction.choices, default=Direction.INCOMING,
    )
...
# ---------------------------------------------------------------------------
# NotificationLog – higher-level record of notifications sent to users
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# FuelRequest – fuel request initiated via WhatsApp
# ---------------------------------------------------------------------------
...
class FuelRequest(TimeStampedModel):
    ...
    def __str__(self):
        return (
            f"Fuel {self.liters_requested}L – {self.trip.order_number} – {self.status}"
        )
